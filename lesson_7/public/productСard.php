			...
			<div class="product-content__right">
				<div class="product-head__text">
					...
					<p class="product-head__lead">
						Ищите мощный и красивый компьютер для игр? <?=$good['nameGoods']?> создан именно для вас. Высокая производительность и великолепный дизайн в одном системном блоке.	
					</p>
					<hr>
					<div class="product-head__purchase">
						...
						<a class="product-head__btn" href="basket.php?id=<?=$good['id']?>">Купить</a>
					</div>
					<hr>
